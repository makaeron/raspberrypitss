...
var optionsColumn = {
  ...
  title: {
    text: 'Global RTMS Risk Level Average',
    align: 'left',
    style: {
      fontSize: '12px'
    }
...
var optionsLine = {
  ...
  series: [{
    name: 'Attack Windows Found',
    data: generateMinuteWiseTimeSeries(new Date("12/12/2016 00:20:00").getTime(), 12, {
      min: 30,
      max: 110
    })
  }, {
    name: 'Pattern Windows Found',
    data: generateMinuteWiseTimeSeries(new Date("12/12/2016 00:20:00").getTime(), 12, {
      min: 30,
      max: 110
    })
  ...
  title: {
    text: 'Attack/Pattern Windows Found Containing Search Terms',
    align: 'top',
    style: {
      fontSize: '12px'
    }
...
var optionsCircle = {
  ...
  series: [71, 63],
  labels: ['Entity: 192.168.5.26', 'Entity: 192.168.6.11'],
  legend: {
    show: true,
    position: 'left',
    offsetX: -30,
