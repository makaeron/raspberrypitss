...
default_args = {
 ...
 'companyname': 'Otics',  # <<< ********** You change as needed
  ...
  'raw_data_topic' : 'iot-raw-data,agent-responses,team-lead-responses,supervisor-responses,all-agents-responses', # Separate multiple topics with comma <<< ********** You change topic names as needed
  ...
  'pgpt_data_topic' : '',  #  PrivateGPT will produce responses to this topic - change as  needed
