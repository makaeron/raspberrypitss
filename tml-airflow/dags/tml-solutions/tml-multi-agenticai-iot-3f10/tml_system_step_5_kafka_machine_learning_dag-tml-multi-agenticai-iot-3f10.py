...
default_args = {
  ...
  'rollbackoffsets' : '800', # <<< *** Change as needed, 
  'consumeridtrainingdata2': '', # leave blank
  'partition_training' : '',  # leave blank
  'consumefrom' : '',  # leave blank
  'topicid' : '-1',  # leave as is
  'fullpathtotrainingdata' : '/rawdata/iotlogistic',  #  # <<< *** Change as needed - add name for foldername that stores the training datasets
