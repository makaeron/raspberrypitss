...
default_args = {
 ...
 'solutionname': 'tml-multi-agenticai-iot-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'TML Multi-Agentic AI Solution for IoT ', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'This is an awesome TML Multi-Agentic AI real-time solution for IoT device monitoring built by TSS',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
 'COMPANYNAME' : 'Otics',       
