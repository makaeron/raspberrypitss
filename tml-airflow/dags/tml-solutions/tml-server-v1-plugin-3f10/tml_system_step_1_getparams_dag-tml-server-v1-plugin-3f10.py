...
default_args = {
 ...
 'solutionname': 'tml-server-v1-plugin-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'TML REST API Server Plugin', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'This is a TML server plug-in that uses REST API - allowing access from ANY application',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
