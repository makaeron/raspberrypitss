...
default_args = {
  ...
  'dashboardhtml-ml-ai': 'iot-failure-machinelearning-agenticai.html', # <<< *** This one is you include ML-AI dag
  'topic-ml-ai' : 'all-agents-responses,iot-preprocess,iot-ml-prediction-results-output',    # <<< *** Separate multiple topics by a comma    
