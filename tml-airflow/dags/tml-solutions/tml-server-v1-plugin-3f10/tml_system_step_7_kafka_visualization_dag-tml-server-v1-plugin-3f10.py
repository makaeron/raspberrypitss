...
default_args = {
  ...
  'dashboardhtml': 'iot-failure-machinelearning.html', # <<< *** name of your dashboard file: This one is ONLY for preprocessing
  'dashboardhtml-ml': 'iot-failure-machinelearning.html', # <<< *** This one is IF you include ML dag
  'topic-ml' : 'iot-preprocess,iot-preprocess2',    # <<< *** Separate multiple topics by a comma
  'dashboardhtml-ai': 'iot-failure-machinelearning.html', # <<< *** This one is you include AI dag
