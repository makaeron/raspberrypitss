...
default_args = {
 ...
 'companyname': 'Otics',  # <<< ********** You change as needed
  ...
  'raw_data_topic' : 'iot-raw-data,rtms-stream-mylogs,rtms-stream-mylogs2', # Separate multiple topics with comma <<< ********** You change topic names as needed
  'preprocess_data_topic' : 'iot-preprocess,iot-preprocess2,rtms-preprocess,attacktopic,rtmstopic,patterntopic', # Separate multiple topics with comma <<< ********** You change topic names as needed
