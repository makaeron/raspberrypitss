...
default_args = {
 ...
 'brokerhost' : 'pkc-3w22w.us-central1.gcp.confluent.cloud:9092',  # <<<<***************** THIS WILL ACCESS LOCAL KAFKA - YOU CAN CHANGE TO CLOUD KAFKA HOST
 'brokerport' : '',     # <<<<***************** LOCAL AND CLOUD KAFKA listen on PORT 9092
 ...
 'solutionname': 'hysyssolutiondemo-3f10',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
 'solutiontitle': 'TML HYSYS Solution: Oil and Gas Demo', # <<< *** Provide a descriptive title for your solution
 ...
 'description': 'This solution is using TML to process data from HYSYS and Perform Entity-Based Machine Learning for Each Well',   # <<< *** Provide a description of your solution
 'HTTPADDR' : 'https://',
 'COMPANYNAME' : 'FirstGenesis',       
