...
default_args = {
  ...
  'preprocess_data_topic' : 'hysys-preprocess', # << *** topic/data to use for training datasets - You created this in STEP 2
  'ml_data_topic' : 'ml-data', # topic to store the trained algorithms  - You created this in STEP 2
  'identifier' : 'TML HYSYS solution',    # <<< *** Change as needed   
  'companyname' : 'FirstGenesis', # <<< *** Change as needed      
  'myemail' : 'sebastian.maurice@otics.ca', # <<< *** Change as needed      
  'mylocation' : 'Toronto', # <<< *** Change as needed      
  'brokerhost' : '', # <<< *** Leave as is   
  'brokerport' : '-999', # <<< *** Leave as is
  'deploy' : '1', # <<< *** do not modofy
  'modelruns': '80', # <<< *** Change as needed      
  ...
  'dependentvariable' : 'Vapor-1_preprocessed_Avg', # <<< *** Change as needed, 
  'independentvariables': 'psia_preprocessed_Avg,Choke_preprocessed_Avg,V-200_preprocessed_Avg,F_preprocessed_Avg,PIC-100_preprocessed_Avg,LIC-101_preprocessed_Avg', # <<< *** Change as needed, 
  'rollbackoffsets' : '450', # <<< *** Change as needed, 
  'consumeridtrainingdata2': '', # leave blank
  'partition_training' : '',  # leave blank
  'consumefrom' : '',  # leave blank
  'topicid' : '-1',  # leave as is
  'fullpathtotrainingdata' : '/rawdata/viper-ml/hysys',  #  # <<< *** Change as needed - add name for foldername that stores the training datasets
