...
default_args = {
 ...
 'companyname': 'Otics',  # <<< ********** You change as needed
  ...
  'raw_data_topic' : 'hysys-data', # Separate multiple topics with comma <<< ********** You change topic names as needed
  'preprocess_data_topic' : 'hysys-preprocess', # Separate multiple topics with comma <<< ********** You change topic names as needed
  'ml_data_topic' : 'ml-data', # Separate multiple topics with comma <<< ********** You change topic names as needed
  'prediction_data_topic' : 'hysys-gas-predictions', # Separate multiple topics with comma <<< ********** You change topic names as needed
  'pgpt_data_topic' : 'tml-privategpt',  #  PrivateGPT will produce responses to this topic - change as  needed
