...
default_args = {
  ...
  'preprocess_data_topic' : 'hysys-preprocess', # << *** data for the independent variables - You created this in STEP 2
  'ml_prediction_topic' : 'hysys-gas-predictions', # topic to store the predictions - You created this in STEP 2
  ...
  'streamstojoin' : 'psia_preprocessed_Avg,Choke_preprocessed_Avg,V-200_preprocessed_Avg,F_preprocessed_Avg,PIC-100_preprocessed_Avg,LIC-101_preprocessed_Avg', # << ** These are the streams in the preprocess_data_topic for these independent variables
  ...
  'maxrows' : '500',  # << ** the number of offsets to rollback - For example, if 50, you will get 50 predictions continuously 
  'produceridhyperprediction' : '',  # << leave blank
  'consumeridtraininedparams' : '',  # << leave blank
  'groupid' : '',  # << leave blank
  'topicid' : '-1',   # << leave as is
  'pathtoalgos' : '/rawdata/viper-ml/hysys', # << this is specified in fullpathtotrainingdata in STEP 5
