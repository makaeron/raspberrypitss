...
default_args = {
  ...
  'raw_data_topic' : 'hysys-data', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  'preprocess_data_topic' : 'hysys-preprocess', # *************** INCLUDE ONLY ONE TOPIC - This is one of the topic you created in SYSTEM STEP 2
  ...
  'identifier' : 'TML Hysys Solution Demo', # <<< ** Change as needed
  ...
  'jsoncriteria' : 'uid=Datapoint.WellId,filter:allrecords~\
subtopics=Datapoint.Children.Vapor1.Name,Datapoint.Pressure.Unit,Datapoint.Children.Choke.Name,Datapoint.Children.V200.Name,Datapoint.Children.V200.Temperature.Unit,Datapoint.Children.Pic100.Name,Datapoint.Children.Lic101.Name~\
values=Datapoint.Children.Vapor1.GasFlowRate.Value,Datapoint.Pressure.Value,Datapoint.Children.Choke.OutletPressure.Value,Datapoint.Children.V200.Pressure.Value,Datapoint.Children.V200.Temperature.Value,Datapoint.Children.Pic100.SetPoint.Value,Datapoint.Children.Lic101.SetPoint.Value~\
identifiers=Datapoint.Children.Vapor1.Name,Datapoint.Pressure.Unit,Datapoint.Children.Choke.Name,Datapoint.Children.V200.Name,Datapoint.Children.V200.Temperature.Unit,Datapoint.Children.Pic100.Name,Datapoint.Children.Lic101.Name~\
datetime=Metadata.SecondsTimestamp~\
msgid=Metadata.Id~\
